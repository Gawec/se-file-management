...
def main():
    while True:
        starting_path = sg.popup_get_folder(
            "Folder to display", history=True, history_setting_filename="search_history"
        )
    ...
    while True:  # Event Loop
        ...
        if event in ("Browse", "Enter-key"):
            ...
            try:
                ...
                sg.popup_ok(
                    "You do not have the permission to access this folder!",
                    "Aborting action...",
                    keep_on_top=True,
                )
        ...
        if event == "Rename":
            ...
            try:
                ...
                try:
                    ...
                    sg.popup_ok(
                        "You can not change the name of this object!",
                        "Aborting action...",
                        keep_on_top=True,
                    )
